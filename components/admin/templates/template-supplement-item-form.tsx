/**
 * Template Supplement Item Form
 *
 * Form for adding/editing supplement items in a template.
 * Adapted from SupplementItemForm for template items.
 */
...
/**
 * Form for adding/editing template supplement items
 */
export function TemplateSupplementItemForm({
  isOpen,
  onClose,
  onSuccess,
  templateId,
  ...
  // Mutations
  const createMutation = useCreate<TemplateSupplementItem>();
  const updateMutation = useUpdate<TemplateSupplementItem>();
